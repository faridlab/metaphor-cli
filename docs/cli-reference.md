...
**plugins**
- For each known plugin (`metaphor-schema`, `metaphor-codegen`, `metaphor-dev`, `metaphor-agent`): OK if discovered via `$METAPHOR_PLUGIN_BIN_DIR` or `$PATH`, WARN otherwise.
